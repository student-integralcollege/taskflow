                    ...
                    <div ref={menuref} className='relative'>
                        ...
                        {isMenuOpen && (
                            <ul className='absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn'>
                                <li className='p-2'>
                                    <button onClick={()=>{setIsMenuOpen(false); navigate('/profile')}} className='w-full text-left px-4 py-2 text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-300'>
                                        Profile
                                    </button>
                                </li>
                            </ul>
